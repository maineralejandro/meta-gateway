...
UPDATE agents SET fallback_responses = '{"price": "¿Qué producto te interesa? Puedo consultarte el precio de cualquier item.", "promo": "Pregunta por nuestras promociones del día!", "default": "No estoy seguro de tu pregunta. ¿Podrías aclarar?"}' WHERE id = 1;
